...
$_SESSION["no_of_tickets"] = $_POST['no_of_tickets'];
$_SESSION["registration_id"] = ("ROSHAN-" . mt_rand());
            ...
            <form class="needs-validation" novalidate action="register.php" method="POST" onSubmit="return confirm('This is the final submit') ">
                ...
                <div class="form-group">
                    <div>
                        ...
                        <input type="text" class="form-control" value="<?php echo $_SESSION["registration_id"] ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="<?php echo $_SESSION["fname"] ?>" readonly>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="last_name">Last Name</label>
                        <input type="text" class="form-control" value="<?php echo $_SESSION["lname"] ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="tel" class="form-control" value="<?php echo $_SESSION["phone"] ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div>
                        ...
                        <input type="text" class="form-control" value="<?php echo $_SESSION["registration_type"] ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control" value="<?php echo $_SESSION["no_of_tickets"] ?>" id="no_of_tickets" name="no_of_tickets" readonly>
                    </div>
                </div>
